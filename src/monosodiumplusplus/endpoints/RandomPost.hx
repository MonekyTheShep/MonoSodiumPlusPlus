...
class RandomPost {
    ...
    public function setTag(tag:String):RandomPost {
        this.tags.push(tag);
        return this;
    }


    public function removeTag(tag:String):RandomPost {
    ...
    public function search(onSuccess:PostsSchema->Void, onError:String->Void):Void {
        var httpBuilder:HttpBuilder = new HttpBuilder(monosodium.getUrl() + '/posts/random.json');
